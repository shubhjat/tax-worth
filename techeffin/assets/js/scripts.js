...
$(function () {
  ...
  var toggle_sidebar_mini = function (mini) {
    ...
    var dataString = 'action=changeSidebar'+ '&code='+ _val;
      $.ajax({
        type: "POST",
        url: "index.php?console=changeTheme",
        data:dataString,
        cache: false,
  ...
  $(".layout-color input:radio").change(function () {
    ...
    var code = $(this).val();
    var dataString = 'action=changeTheme'+ '&code='+ code;
      $.ajax({
        type: "POST",
        url: "index.php?console=changeTheme",
        data:dataString,
  ...
  var _val = $('#mini_sidebar_setting').is(":checked") ? "checked" : "unchecked";
  if (_val === "checked") {
